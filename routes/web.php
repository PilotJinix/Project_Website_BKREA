...
Route::get('/logadmin', 'Admin\Auth\AuthController@login')->name('logadmin');
Route::get('/Alogout', 'Admin\Auth\AuthController@Alogout')->name('Alogout');
Route::post('/postlogin', 'Admin\Auth\AuthController@postlogin')->name('postlogin');
