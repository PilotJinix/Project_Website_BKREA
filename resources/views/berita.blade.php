                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                    <div class="el-card el-card-blog el-card-blog-1 el-hover">
                        <div class="post-image">
                            <img src="{{asset('storage/berita/'.$dataa->gambar)}}" alt="--Alternative--">
                            <a href="{{route('detailberita',$dataa->id)}}" class="button button-read-more">
                                <span class="text">Read More</span>
                            </a>
                        </div>
                        <div class="details">
                            <h3>
                                <a href="{{route('detailberita', $dataa->id)}}" title="Fila Locker Room Varsity Jacket">
                                    <span class="text">{{__($dataa->judul)}}</span>
                                </a>
                            </h3>
