                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="streamline b-l m-b m-l">
                                <div class="sl-item">
                                    <div class="sl-left">
                                        <img src="{{asset('admin/assets/images/a2.jpg')}}" class="img-circle">
                                    </div>
                                    <div class="sl-content">
                                ...
                                <div class="sl-item">
                                    <div class="sl-left">
                                        <img src="{{asset('admin/assets/images/a5.jpg')}}" class="img-circle">
                                    </div>
                                    <div class="sl-content">
                                ...
                                <div class="sl-item">
                                    <div class="sl-left">
                                        <img src="{{asset('admin/assets/images/a8.jpg')}}" class="img-circle">
                                    </div>
                                    <div class="sl-content">
            ...
            <div class="row">
                    ...
                    <div class="box">
                        ...
                        <ul class="list-group no-border">
                            <li class="list-group-item">
                                <a href="#" class="pull-left w-40 m-r"><img src="{{asset('admin/assets/images/a1.jpg')}}" class="img-responsive img-circle"></a>
                                <div class="clear">
                            ...
                            <li class="list-group-item">
                                <a href="#" class="pull-left w-40 m-r"><img src="{{asset('admin/assets/images/a2.jpg')}}" class="img-responsive img-circle"></a>
                                <div class="clear">
                            ...
                            <li class="list-group-item">
                                <a href="#" class="pull-left w-40 m-r"><img src="{{asset('admin/assets/images/a3.jpg')}}" class="img-responsive img-circle"></a>
                                <div class="clear">
                            ...
                            <li class="list-group-item">
                                <a href="#" class="pull-left w-40 m-r"><img src="{{asset('admin//assets/images/a4.jpg')}}" class="img-responsive img-circle"></a>
                                <div class="clear">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="box">
	                	...
	                	<span class="w-40">
	                  		<img src="{{asset('admin/assets/images/b1.jpg')}}" class="w-full" alt="...">
	                 	</span>
                                </a>
                                <div class="clear">
                            ...
                            <li class="list-item">
                                <a herf class="pull-left m-r">
		                <span class="w-40">
	                  		<img src="{{asset('admin/assets/images/b2.jpg')}}" class="w-full" alt="...">
	                 	</span>
                                </a>
                                <div class="clear">
                            ...
                            <li class="list-item">
                                <a herf class="pull-left m-r">
	                    <span class="w-40">
	                  		<img src="{{asset('admin/assets/images/b3.jpg')}}" class="w-full" alt="...">
	                 	</span>
                                </a>
                                <div class="clear">
                            ...
                            <li class="list-item">
                                <a herf class="pull-left m-r">
	                    <span class="w-40">
	                  		<img src="{{asset('admin/assets/images/b4.jpg')}}" class="w-full" alt="...">
	                 	</span>
                                </a>
                                <div class="clear">
                            ...
                            <li class="list-item">
                                <a herf class="pull-left m-r">
	                    <span class="w-40">
	                  		<img src="{{asset('admin/assets/images/b5.jpg')}}" class="w-full" alt="...">
	                 	</span>
                                </a>
                                <div class="clear">
